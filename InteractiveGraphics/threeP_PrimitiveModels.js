...
function start() {
    ...
    //Creating Scene and Camera 
      ...
      scene.fog = new THREE.FogExp2(0xffffff, 0.2);
       ...
       // initialize objects
	var sphereMaterial = getMaterial('basic', 'rgb(255, 255, 255)');
    ...
    //array for combining cubemap 
	var urls = [
        //getting images from the cubemap folder.
        //initializing an array of links, px.png, nx.png, py.png, etc.
		path + 'px' + format, path + 'nx' + format,
		path + 'py' + format, path + 'ny' + format,
		path + 'pz' + format, path + 'nz' + format
    ];
    //Telling our new reflectionCube object to load the array
    var reflectionCube = new THREE.CubeTextureLoader().load(urls);
    
    //Setting color format of cubemap
	reflectionCube.format = THREE.RGBFormat;

    //adding the reflection cube to the scene
    ...
    planeMaterial.roughnessMap = loader.load('images/concrete.jpg');
