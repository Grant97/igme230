...
function start() {
    ...
    loader.load('coffee.obj', function (object) {
      ...
      //load 1st. external geometry Coffee cup from Cinema 4D's content browser
      var loader = new THREE.OBJLoader();
      var textureLoader = new THREE.TextureLoader();
     
      loader.load('Iphone_XR2.obj', function (object) {
       ...
       //load 2nd external geometry. Iphone I modeled for product advertisment.
      var loader = new THREE.OBJLoader();
      var textureLoader = new THREE.TextureLoader();
