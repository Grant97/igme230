...
function start() {
    ...
    //Creating Scene and Camera 
      ...
      var sMenu = gui.addFolder('SpotLight')
      sMenu.add(spotLight, 'intensity', 0, 10);
      sMenu.add(spotLight.position, 'x', 0, 20);
      sMenu.add(spotLight.position, 'y', 0, 20);
      sMenu.add(spotLight.position, 'z', 0, 20);
      //Gui used to soften spotlight edge
      sMenu.add(spotLight, 'penumbra', 0, 1);
